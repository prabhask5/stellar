...
// =============================================================================
//
//  Validates a pair of Supabase credentials (URL + publishable key) by making
...
//  stellar-drive, which:
//    1. Reads `supabaseUrl` and `supabasePublishableKey` from the JSON body.
 ...
 * publishable key by attempting a real connection. Returns a JSON response
